...
-- 7. Compare Domino’s stock performance before and after major economic events (e.g., COVID-19 pandemic)
select 
    case 
        when date between '2020-01-01' and '2020-12-31' then 'during pandemic' 
        else 'other periods' 
    end as period, 
    avg(close) as avg_close_price 
from dpz 
